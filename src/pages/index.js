...
export default function Home() {
  return (
    <Base>
      ...
      <section className="container pt-[110px] md:pt-[254px] min-h-[5000px]">
        {/* Banner */}
        <div className="flex flex-col lg:flex-row">
          <div className="flex flex-col justify-start w-full">
            ...
            <p className="mt-[20px] md:mt-[136px] text-white leading-6">
              ...
              receive a diamond badge, with a trading volume of 500,000 AVAX in
              three days. The inscription takes more than 1 month from the
        ...
        <div className="flex flex-wrap justify-center lg:justify-start max-w-[880px] gap-4 mt-[24px] md:mt-[60px]">
          <Link href="/" className="site-link">
            <Image alt="AVALANCHE" src="/images/home/top_card_logo_1.svg" width={132} height={118} className="w-[70%] h-auto" />
          </Link>
          <Link href="/" className="site-link">
            <Image alt="Bitget" src="/images/home/top_card_logo_2.svg" width={72} height={118} className="h-[63.4%] w-auto" />
          </Link>
          <Link href="/" className="site-link">
          <Image alt="Gate.io" src="/images/home/top_card_logo_3.svg" width={72} height={118} className="h-[63.4%] w-auto" />
          </Link>
          <div className="w-[186px] aspect-square hidden lg:flex" />
          <div className="w-[186px] aspect-square hidden lg:flex" />
          <Link href="/" className="site-link">
          <Image alt="BitMart" src="/images/home/top_card_logo_4.svg" width={72} height={118} className="h-[63.4%] w-auto" />
          </Link>
          <Link href="/" className="site-link">
          <Image alt="CoinGeko" src="/images/home/top_card_logo_5.png" width={116} height={118} className="h-[63.4%] md:h-[118px] w-auto md:w-[116px]" />
          </Link>
          <Link href="/" className="site-link">
          <Image alt="CoinMarketCap" src="/images/home/top_card_logo_6.svg" width={72} height={118} className="h-[63.4%] w-auto" />
          </Link>
        </div>
      </section>
    </Base>
