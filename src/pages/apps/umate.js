    ...
    <Base>
      ...
      {loading ? (
        ...
        <section className="animate pt-[90px] md:pt-[140px] pb-[50px] md:pb-[100px] overflow-x-hidden">
          ...
          {/* Opensource Link */}
          <div className="flex w-full h-[60px] mx-auto mt-[30px] md:mt-[60px] items-center justify-center">
            <a href="/upload/avav-demo.zip" download="avav-demo.zip">
              <div className="group flex items-center justify-center relative w-[350px] h-[50px] hover:w-[360px] hover:h-[60px] transition-all duration-200 ease-linear">
                <Image
                  ...
                  width={350}
                  height={50}
                  className="-z-10 absolute left-0 top-0 opacity-100 w-[350px] h-[50px] group-hover:w-[360px] group-hover:h-[60px] group-hover:opacity-70 group-active:w-[360px] group-active:h-[60px] group-active:opacity-70 transition-all duration-200 ease-linear"
                />
