...
export default function Entrance({ text, handleClick, handleIconClick }) {
  return (
    <div className="animate flex flex-wrap justify-center lg:justify-start gap-4">
      ...
      <Link
        href="https://h5.eeee.com/?ref=EAW6SB&forward_url=1&page=1&channelCode=EAW6SB"
        target="_blank"
        className="site-link relative"
      >
        <Image
      ...
      {/* CoinEx */}
      <Link
        href="https://www.coinex.com/en/info/AVAV"
        target="_blank"
        className="site-link relative"
      >
        <Image
          alt="CoinEx"
          src="/images/home/entrance/coinex-logo.png"
          width={125}
          height={118}
          className="h-[63.4%] w-auto md:h-[118px]"
        />
